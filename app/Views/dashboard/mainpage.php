...
<body>
    ...
    <script>
        ...
        function showConfirmation() {
            var isSeller = confirm("Apakah Anda seorang Penjual?");

            if (isSeller) {
                window.location.href = "/dashboardpenjual/"; // Replace with the URL of the seller's dashboard page
            } else {
                // No action needed if the user is not a seller
            }
        }

        window.addEventListener("DOMContentLoaded", function() {
            // Check if user is logged in and show confirmation popup
            var isLoggedIn = true; // Replace with your login check logic
